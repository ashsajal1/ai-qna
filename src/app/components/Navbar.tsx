export default function Navbar() {
    return (
        <nav className="flex items-center justify-center p-3 bg-gradient-to-tr from-blue-600 to-violet-600 text-slate-50 h-[60px]">
            <a href="https://github.com/ashsajal1/ai-qna" target="_blink" className="block">
                <div className="flex items-center justify-center gap-2 p-1 border-r hover:text-slate-200 cursor-pointer">
