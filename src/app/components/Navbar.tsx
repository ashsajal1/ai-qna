export default function Navbar() {
    return (
        <nav className="flex gap-3 items-center justify-center p-3 bg-gradient-to-tr from-blue-600 to-violet-600 text-slate-50 h-[60px]">
            <a href="https://github.com/ashsajal1/ai-qna" target="_blink" className="block">
                <div className="flex items-center justify-center gap-2 p-1 border-r hover:text-slate-200 cursor-pointer pr-3">
                    ...
                    <p className="text-sm md:text-md">View soruce code</p>
                </div>
            </a>

            <a href="mailto:ashsajal@yahoo.com" target="_blink" className="block">
            <div className="flex items-center justify-center gap-2 p-1 hover:text-slate-200 cursor-pointer">
                ...
                <p className="text-sm md:text-md">Contact to Dev</p>
            </div>
            </a>
        </nav>
    )
